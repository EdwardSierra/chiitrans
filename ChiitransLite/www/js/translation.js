(function () {
    ...
    /**
     * updateTranslationResult - updates the translation result of an entry with the specified ID
     *
     * @param {Number} id - the ID of the entry to update the translation result for
     * @param {String} translationResultHtml - the HTML representation of the translation result
     *
     * The function first determines if the entry with the specified ID is an old or new entry
     * based on its value relative to the last entry ID. 
     * If the entry is old, it is found in the history section by matching its ID attribute.
     * If the entry is new, the function calls the `onNewEntry` function with the specified ID
     * and sets the current entry as the entry to update.
     * Finally, the function updates the translation result for the found entry by setting the
     * HTML content of its `#translation` element to the `translationResultHtml` argument.
     */
    ...
    /**
     * translate - A function to translate text using different translation APIs
     * 
     * @param {string} id - The ID of the target element to update with the translation result
     * @param {string} raw - The raw, untranslated text
     * @param {string} src - The source text to be translated 
     * @param {string} translatorsListJson - A JSON string containing a list of translation API names to use
     * @param {string} apiKey - The API key for the translation API(s)
     * 
